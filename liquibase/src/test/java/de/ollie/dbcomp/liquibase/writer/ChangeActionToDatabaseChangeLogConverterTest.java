...
public class ChangeActionToDatabaseChangeLogConverterTest {
	...
	class TestsOfMethod_convert_List_ChangeAction {
		...
		void passAListWithAnAddNotNullConstraintChangeChange_ReturnsADatabaseChangeLogsWithTheCorrectChanges()
			...
			String expected = XML_HEADER //
					+ "    <changeSet author=\"dm-comp\" id=\"ADD-CHANGE-SET-ID-HERE\" objectQuotingStrategy=\"LEGACY\" runOnChange=\"true\">\n" //
					+ "        <addNotNullConstraint columnName=\"ID\" schemaName=\"public\" tableName=\"table\"/>\n" //
					+ "    </changeSet>\n" //
					+ "</databaseChangeLog>\n";
			List<ChangeActionCRO> actions = Arrays
					.asList(
		...
		void passAListWithAnAddForeignKeyChangeChange_ReturnsADatabaseChangeLogsWithTheCorrectChanges()
			...
			String expected = XML_HEADER //
					+ "    <changeSet author=\"dm-comp\" id=\"ADD-CHANGE-SET-ID-HERE\" objectQuotingStrategy=\"LEGACY\" runOnChange=\"true\">\n" //
					+ "        <addForeignKeyConstraint baseColumnNames=\"BASE_COLUMN\" baseTableName=\"BASE_TABLE\" baseTableSchemaName=\"public\" referencedColumnNames=\"REF_COLUMN\" referencedTableName=\"REF_TABLE\" referencedTableSchemaName=\"public\"/>\n" //
					+ "    </changeSet>\n" //
					+ "</databaseChangeLog>\n";
			List<ChangeActionCRO> actions = Arrays
					.asList(
